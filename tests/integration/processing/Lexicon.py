...
@mark.parametrize(
    ...
    [
        ...
        Suite(
            preparation_lines="a = [[20, 12, 23], [-1]]",
            cases=[
                Case(
                    append="a[0][1] = 100\na[1][0] = 10",
                    assertion=ContextAssertion(
...
@mark.parametrize(
    ...
    [
        Suite(
            ...
            cases=[Case(assertion=ContextAssertion(key="a", expected=4))],
        ),
        Suite(
        ...
        Suite(
            preparation_lines="a = 2 - 2",
            cases=[Case(assertion=ContextAssertion(key="a", expected=0))],
        ),
        Suite(
            preparation_lines="a = 2 / 2",
        ...
        Suite(
            ...
            cases=[Case(assertion=ContextAssertion(key="a", expected="ab"))],
        ),
        Suite(
            preparation_lines='a = "a" + "b" + ("c" + "d")',
            cases=[Case(assertion=ContextAssertion(key="a", expected="abcd"))],
        ),
        Suite(
        ...
        Suite(
            ...
            cases=[Case(assertion=ContextAssertion(key="a", expected=2000))],
        ),
        Suite(
        ...
        Suite(
            ...
            cases=[Case(assertion=ContextAssertion(key="a", expected=6.25))],
        ),
        Suite(
            preparation_lines="a = 20 / 1000",
            cases=[Case(assertion=ContextAssertion(key="a", expected=0.02))],
        ),
        Suite(
        ...
        Suite(
            ...
            cases=[Case(assertion=ContextAssertion(key="a", expected=21))],
        ),
        Suite(
        ...
        Suite(
            ...
            cases=[
                Case(
                    append='a["b"] = 1',
                    assertion=MapValueAssertion(
                        key="a", map_key="b", expected=1
                    ),
                ),
                Case(
                    append="a[0] = 2",
                    assertion=MapValueAssertion(
                        key="a", map_key=0, expected=2
                    ),
                ),
                Case(
                    append="a[0.5] = 3",
                    assertion=MapValueAssertion(
                        key="a", map_key=0.5, expected=3
                    ),
                ),
                Case(
                    append='b = "key"\n' "a[b] = 4",
                    assertion=MapValueAssertion(
                        key="a", map_key="key", expected=4
                    ),
                ),
            ],
        ),
            ...
            cases=[
                Case(
                    ...
                    assertion=[
                        ...
                        ContextAssertion(key="m", expected=[1, -1]),
                    ],
                ),
                Case(
                    append="m = a to List[int]\n" "m[1] = -1\n" "a = m",
                    assertion=ContextAssertion(key="a", expected=[1, -1]),
                ),
                Case(
                    append="m = a to List[int]\n" "m[0] = 0\n" "a = m",
                    assertion=ContextAssertion(key="a", expected=[0, 2]),
                ),
            ],
        ),
        Suite(
        ...
        Suite(
            ...
            cases=[
                Case(
                    ...
                    assertion=ContextAssertion(key="a", expected="helloworld"),
                ),
                Case(
                    append='a = hello + " " + world',
                    assertion=ContextAssertion(
                ...
                Case(
                    append='a = hello + " "',  # Test for no auto trim.
        ...
        Suite(
            ...
            cases=[
                Case(
                    ...
                    assertion=ContextAssertion(key="aString", expected="1000"),
                ),
                Case(
                    append="sum = a + b\n" "sumString = sum to string",
                    assertion=ContextAssertion(
                        key="sumString", expected="11000"
                    ),
                ),
            ],
        ),
        Suite(
            ...
            cases=[
                Case(
                    append="c = a + true",
                    assertion=ContextAssertion(key="c", expected=2),
                ),
                Case(
                    append="c = a + false",
                    assertion=ContextAssertion(key="c", expected=1),
                ),
            ],
        ),
        Suite(
            ...
            cases=[
                Case(
                    assertion=ContextAssertion(key="a", expected={"a": [1, 2]})
                ),
                Case(
                    assertion=ContextAssertion(
                        key="b", expected={"a": [10, 2]}
                    )
                ),
            ],
        ),
...
@mark.parametrize(
    ...
    [
        Suite(
            ...
            cases=[Case(assertion=ContextAssertion(key="a", expected="yoda"))],
        ),
        Suite(
            preparation_lines='planet = "mars"',
            cases=[
                Case(
                    assertion=ContextAssertion(key="planet", expected="mars")
                ),
                Case(
                    append='a = {"planet": planet, "element": "air"}',
                    assertion=ContextAssertion(
                        key="a", expected={"planet": "mars", "element": "air"}
                    ),
                ),
            ],
        ),
            ...
            cases=[
                Case(
                    assertion=ListItemAssertion(
                        key="planet", index=0, expected="mars"
                    )
                ),
                Case(
                    assertion=ListItemAssertion(
                        key="planet", index=1, expected="earth"
                    )
                ),
            ],
        ),
        Suite(
            ...
            cases=[
                Case(
                    assertion=MapValueAssertion(
                        key="planet", map_key="name", expected="mars"
                    )
                )
            ],
        ),
        ...
        Suite(
            preparation_lines="a = [true]",
            cases=[Case(assertion=ContextAssertion(key="a", expected=[True]))],
        ),
        Suite(
        ...
        Suite(
            ...
            cases=[
                Case(
                    append="if i == null\n" "    status = 1",
                    assertion=ContextAssertion(key="status", expected=1),
                ),
                Case(
                    append="if not(i == null)\n" "    status = 2",
                    assertion=ContextAssertion(key="status", expected=0),
                ),
            ],
        ),
    ],
    ...
    [
        Suite(
            cases=[
                ...
                Case(
                    append="a = 2 to string",
                    assertion=ContextAssertion(key="a", expected="2"),
                ),
                Case(
                    append='a = {2: "42"} to Map[float,float]',
                    assertion=ContextAssertion(key="a", expected={2.0: 42.0}),
                ),
                Case(
                    append='a = "foo" to regex',
                    assertion=ContextAssertion(
                        key="a", expected=re.compile("foo")
                    ),
                ),
                ...
                Case(
                    append="a = true to int",
                    assertion=ContextAssertion(key="a", expected=1),
                ),
                Case(
                    append="a = false to int",
                    assertion=ContextAssertion(key="a", expected=0),
                ),
                Case(
                    append='a = {"foo": 42} to Map[string,int]',
                    assertion=ContextAssertion(key="a", expected={"foo": 42}),
                ),
                Case(
    ...
    [
        ...
        Suite(
            ...
            cases=[
                ...
                Case(assertion=ContextAssertion(key="prefix", expected=None)),
                Case(
                    assertion=ContextAssertion(key="name", expected="nobody")
                ),
            ],
        ),
        Suite(
...
@mark.parametrize(
    ...
    [
        Suite(
            ...
            cases=[
                Case(
                    ...
                    "outside = true",
                    assertion=[
                        ContextAssertion(key="found", expected=True),
        ...
        Suite(
            ...
            "  value_sum += value\n",
            cases=[
                Case(assertion=ContextAssertion(key="index_sum", expected=3)),
                Case(assertion=ContextAssertion(key="value_sum", expected=27)),
            ],
        ),
        Suite(
    ...
    [
        ...
        Suite(
            ...
            cases=[
                Case(
                    append="value = foo()",
                    assertion=ContextAssertion(key="value", expected=True),
                )
            ],
        ),
    ],
...
@mark.parametrize(
    ...
    [
        ...
        Suite(
            ...
            cases=[
                Case(
                    append="if true or false\n" '   c = "true"',
                    assertion=ContextAssertion(key="c", expected="true"),
                ),
                Case(
                    append="if false or true\n" '   c = "true"',
                    assertion=ContextAssertion(key="c", expected="true"),
                ),
                Case(
                    append="if true\n" '   c = "true"',
                ...
                Case(
                    append="if a == 100 or b == 100\n" '   c = "wtf"',
                    assertion=ContextAssertion(key="c", expected=None),
                ),
                Case(
                    append="if a == 100 or b == 5\n" '   c = "b"',
                    assertion=ContextAssertion(key="c", expected="b"),
                ),
                Case(
                    append="if a == 1 or b == 100\n" '   c = "a"',
                    assertion=ContextAssertion(key="c", expected="a"),
                ),
                Case(
                    append="if a == 1 or b == 5\n" '   c = "a"',
                    assertion=ContextAssertion(key="c", expected="a"),
                ),
                Case(
                    append="if a == 100 or b == 100 or true\n" '   c = "true"',
                    assertion=ContextAssertion(key="c", expected="true"),
                ),
            ],
        ),
        Suite(
            ...
            cases=[
                Case(
                    prepend='colour = "blue"',
                    assertion=[
                        ContextAssertion(key="result", expected="blue"),
                        ContextAssertion(
                            key="outside_var", expected="executed"
                        ),
                    ],
                ),
                Case(
                    prepend='colour = "red"',
                    assertion=[
                        ContextAssertion(key="result", expected="red"),
                        ContextAssertion(
                            key="outside_var", expected="executed"
                        ),
                    ],
                ...
                Case(
                    prepend='colour = "yellow"',
                    assertion=[
                        ContextAssertion(key="result", expected="yellow"),
                        ContextAssertion(
                            key="outside_var", expected="executed"
                        ),
                    ],
                ...
                Case(
                    prepend='colour = "green"',
                    assertion=[
                        ContextAssertion(key="result", expected="green"),
                        ContextAssertion(
                            key="outside_var", expected="executed"
                        ),
                    ],
                ...
                Case(
                    prepend='colour = "pink"',
                    assertion=[
                        ContextAssertion(key="result", expected="unknown"),
                        ContextAssertion(
                            key="outside_var", expected="executed"
                        ),
                    ],
    ...
    [
        ...
        Suite(
            ...
            cases=[
                ...
                Case(append="echo(i: 28)", assertion=[]),
                Case(
                    append="a = add(a: 10 b: 20)",
                    assertion=ContextAssertion(key="a", expected=30),
                ),
                Case(
                    append="a = add(a: 10 b: 20) + get_28()",
        ...
        Suite(
            ...
            cases=[
                Case(
                    ...
                    'err5 = ""',
                    assertion=[
                        ContextAssertion(key="result0", expected="0"),
                        ContextAssertion(key="result1", expected="1"),
                        ContextAssertion(key="result2", expected="2"),
                        ContextAssertion(key="result3", expected="3"),
                        ContextAssertion(key="result4", expected="4"),
                        ContextAssertion(key="err1", expected="1"),
                        ContextAssertion(key="err2", expected="2"),
                        ContextAssertion(key="err3", expected="3"),
                        ContextAssertion(key="err4", expected="4"),
                        ContextAssertion(key="err5", expected="5"),
                    ],
                )
            ],
        ),
