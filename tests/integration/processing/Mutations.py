    ...
    Suite(
        ...
        cases=[
            ...
            Case(
                ...
                assertion=ContextAssertion(key='a', expected='HELLO WORLD!')
            ),
            Case(
    ...
    Suite(
        ...
        cases=[
            ...
            Case(
                ...
                assertion=ContextAssertion(key='arr', expected=[1, 2, 3, 4, 5])
            ),
            Case(
