...
async def test_service_file_write(patch, story, line, file_io):
    patch.object(story.app, "get_tmp_dir", return_value="/tmp/my.story")
    story.execution_id = "super_super_tmp"
    resolved_args = {"path": "my_path", "content": "my_content"}
...
async def test_service_file_list(
    magic, patch, story, line, recursive, file_io
):
    patch.object(story.app, "get_tmp_dir", return_value="/tmp/my.story")
    story.execution_id = "super_super_tmp"
    resolved_args = {"path": "my_path", "recursive": recursive}
...
async def test_service_file_remove_dir_exc(
    patch, story, line, exists, file_io
):
    patch.object(story.app, "get_tmp_dir", return_value="/tmp/my.story")
    story.execution_id = "super_super_tmp"
    resolved_args = {"path": "my_path"}
