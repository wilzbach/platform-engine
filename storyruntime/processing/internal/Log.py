...
@Decorators.create_service(
    name="log", command="info", arguments={"msg": {"type": "any"}}
)
...
@Decorators.create_service(
    name="log", command="error", arguments={"msg": {"type": "any"}}
)
...
@Decorators.create_service(
    name="log", command="warn", arguments={"msg": {"type": "any"}}
)
...
@Decorators.create_service(
    name="log", command="debug", arguments={"msg": {"type": "any"}}
)
